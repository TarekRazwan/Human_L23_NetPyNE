...
# Simulation timing
# ---------------------------------------------------------------------------
cfg.duration = 1000.0 if cfg.testing else 4500.0   # ms
...
# Analysis / plotting
# ---------------------------------------------------------------------------
cfg.transient     = 2000.0   # ms to discard in analysis (full run only)
cfg.analysis_tmin = 2000.0 if not cfg.testing else 0.0
